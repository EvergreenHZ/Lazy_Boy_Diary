...
def updata_elo(win_team, lost_team):
    new_winner_rank, new_loser_rank = calc_elo(win_team, lost_team)
    team_elos[win_team] = new_winner_rank
    team_elos[lost_team] = new_loser_rank
