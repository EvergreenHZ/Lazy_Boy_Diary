...
# The database file for training data. Created by data/MyDataset/create_data.sh
train_data = "examples/MyDataset/MyDataset_trainval_lmdb"
# The database file for testing data. Created by data/MyDataset/create_data.sh
...
# Stores the test image names and sizes. Created by data/MyDataset/create_list.sh
